...
const Body = () => {
  return (
    ...
    <div className='space-y-4 lg:flex-1 lg:order-1 lg:space-y-10'>
      ...
      <p className='font-lato text-gray-400'>With Hostify , get your website up and running in no less than 5 minutes with the most competitive pricing packages available online.</p>
